    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
            ...
            <form action="{{ route('roles.update',$role->id) }}" method="POST" class="p-4">
                ...
                <div class="flex gap-4 bg-gray-200 mb-6">
                    ...
                    <div class="ml-3 role-management-checkbox">
                        ...
                        id="permission_{{ $permission->id }}" value="{{ $permission->id }}" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300
                        focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" @if(in_array($permission->id,$data)) checked @endif>
